            ...
            <Modal isOpen={isModalOpen} onClose={closeModal} modal='inmublesModal' title={title}>
                <form onSubmit={save} autoComplete='off'>
                    ...
                    <div className="grid md:grid-cols-4 md:gap-6">
                        ...
                        <div className="relative z-0 w-full mb-5 group">
                            <input type="number" name="precio_descuento" id="precio_descuento" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-acent focus:outline-none focus:ring-0 focus:border-acent peer" placeholder=" " value={inmuebleForm.precio_descuento} onChange={handleChange} required />
                        ...
                        {inmuebleForm.precio_descuento != (inmuebleForm.precio * inmuebleForm.porcentaje_descuento / 100) && (<span className='md:-mt-3 mb-4 md:mb-0 text-sm text-yellow-600'>El precio de descuento es incorrecto según el porcentaje dado: {(inmuebleForm.precio * inmuebleForm.porcentaje_descuento / 100)} </span>)}
